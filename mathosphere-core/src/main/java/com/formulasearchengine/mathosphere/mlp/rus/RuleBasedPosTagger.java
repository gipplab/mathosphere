...
/**
 * Simple rule-based POS tagger for Russian that looks only at the ending or the beginning of a word
 * token to determine the part of speech. <p> The initial implementation taken from
 * http://habrahabr.ru/post/152389/ and rewritten to Java.
 */
public class RuleBasedPosTagger {

  /**
   * Tags taken from Penn Treebank http://www.comp.leeds.ac.uk/amalgam/tagsets/upenn.html
   */
