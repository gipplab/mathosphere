...
public class CMMLInfoTest {
  private static final String MML_TEST_DIR = "com/formulasearchengine/mathosphere/mml/";
  ...
  public final void testStrictCmml1() throws Exception {
    String simpleMathTag = TestUtils.getFileContents(MML_TEST_DIR + "sample.mml");
    String simpleStrictMathTag = TestUtils.getFileContents(MML_TEST_DIR + "reference_sample.mml");
  ...
  private XQueryExecutable getQueryI() throws IOException, ParserConfigurationException {
    final String ciI = TestUtils.getFileContents(MML_TEST_DIR + "I.mml.xml");
  ...
  public final void testGenerateXQuery() throws Exception {
    final String ciI = TestUtils.getFileContents(MML_TEST_DIR + "I.mml.xml");
    final String sampleMML = TestUtils.getFileContents(MML_TEST_DIR + "q1.xml");
