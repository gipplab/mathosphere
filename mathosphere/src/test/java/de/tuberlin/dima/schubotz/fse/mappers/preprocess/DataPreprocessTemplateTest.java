...
public class DataPreprocessTemplateTest extends TestCase {
    ...
    final String testdata= TestUtils.getFileContents("de/tuberlin/dima/schubotz/utils/xmlFailTestEq.xml");
        DataPreprocessTemplate<Tuple1<String>> dp = new DataPreprocessTemplate<Tuple1<String>>() {
            @Override
            public void flatMap(RawDataTuple value, Collector<Tuple1<String>> out) throws Exception {
                return;
            }
        };
     dp.data=testdata;
