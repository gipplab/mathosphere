...
public class UltimateQueryTest extends TestCase {
    ...
    private NonWhitespaceNodeList getTests() throws Exception {
        Document doc = XMLHelper.String2Doc(getQueryFile(), true);
        return new XMLHelper.NonWhitespaceNodeList(doc.getElementsByTagName("topic"));
    }
