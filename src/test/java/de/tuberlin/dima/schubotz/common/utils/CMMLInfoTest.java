...
public class CMMLInfoTest extends TestCase {
    ...
    public void testStrictCmml1() throws Exception {
        String simpleMathTag = TestUtils.getFileContents("de/tuberlin/dima/schubotz/common/utils/sample.mml");
        String simpleStrictMathTag = TestUtils.getFileContents("de/tuberlin/dima/schubotz/common/utils/reference_sample.mml");
