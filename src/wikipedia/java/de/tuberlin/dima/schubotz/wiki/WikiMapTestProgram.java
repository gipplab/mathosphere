 ...
 *
 */
public class WikiMapTestProgram {
	/**
	 ...
	 */
	private static final Log LOG = LogFactory.getLog(WikiMapTestProgram.class);
	/**
	 * Splitter for tokens
	 */
	...
	public static void main(String[] args) {
		try {
			...
			LOG.fatal("Env WikiMapTestProgram execution exception", e);
			e.printStackTrace();
			System.exit(0);
		}
		System.exit(1);
	...
	public static void ConfigurePlan() throws IOException {
        ...
        wikiSet.writeAsCsv(output, CSV_LINE_SEPARATOR,
