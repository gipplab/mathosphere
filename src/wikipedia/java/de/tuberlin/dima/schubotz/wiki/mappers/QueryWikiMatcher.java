	...
	public void flatMap(WikiTuple in, Collector<ResultTuple> out) throws Exception {
        ...
        for (WikiQueryTuple query : queries) {
            ...
            if (!sectionLatex.isEmpty()) {
                ...
                latexScore = ComparisonHelper.calculateTFIDFScore(queryLatex, sectionLatex, latexWikiMultiset, numWiki, debug);
            } else {
                latexScore = 0.;
            }
            ...
            mmlScore = ComparisonHelper.calculateMMLScore(in.getMML(), query.getMML());
